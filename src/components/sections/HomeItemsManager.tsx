...
export const HomeItemsManager: React.FC = () => {
  ...
  const saveCategories = async (updatedCategories: { [key: string]: HomeCategory }) => {
    try {
      ...
      toast.success('Home items updated successfully!');
    } catch (error: any) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Home Items Management</h2>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setItemForm(prev => ({ ...prev, images: e.target.value }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {Object.entries(categoryItems).map(([itemKey, item]) => (
                      <div key={itemKey} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
